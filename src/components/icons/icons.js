...
export const Inbox = ({ className, width = '2.6rem', height = '2.6rem' }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const HomeIcon = ({ className, width = '2.2rem', height = '2.2rem' }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const HomeActiveIcon = ({ className, width = '2.2rem', height = '2.2rem' }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const UserGroupIcon = ({ className, width = '2.2rem', height = '2.2rem' }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const UserGroupActiveIcon = ({ className, width = '2.2rem', height = '2.2rem' }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const LiveIcon = ({ className, width = '2.2rem', height = '2.2rem' }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const LiveActiveIcon = ({ className, width = '2.2rem', height = '2.2rem' }) => {
    return (
        <svg
            className={className}
            width={width}
